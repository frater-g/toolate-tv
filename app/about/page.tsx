    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="border border-chrome p-8 bg-metal-gray/50 space-y-6">
        ...
        <section>
          ...
          <p className="text-steel leading-relaxed">
            the too late show satirizes tech culture, corrupt elites, and information warfare. 
            we examine dark technology, surveillance, conspiracy culture, governmental 
            dysfunction, and the ways systems manipulate perception and reality. First, we make you laugh. Then, we do a SQL injection into your brain stem to make you accidentally learn something.
          </p>
        </section>
